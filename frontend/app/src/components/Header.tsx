                    ...
                    <nav id="l-nav-options" className="h-full w-full flex gap-5 justify-end items-center xl:text-[15px]">
                        ...
                        <div className="flex gap-1 cursor-pointer" onClick={() => dispatch(openSideCart())}>
                            <div className="flex relative">
                                ...
                                <span className="absolute right-1.5 top-[-12px] size-3 rounded-full text-center text-[12px]">{cart.cart_items?.length ?? 0}</span>
                            </div>
                            

                            <span className="hidden md:inline hover:text-gray-700">
                                SHOPPING CART
